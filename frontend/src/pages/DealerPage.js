...
export default function DealerPage() {
  ...
  return (
    <div data-testid="dealer-page" className="pt-20 min-h-screen bg-[#1A1A1A]">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-['IBM_Plex_Sans'] text-white/70 text-lg mb-8">
              ...
              <div className="flex items-center gap-6">
                <div>
                  ...
                  <p className="text-white/60 text-sm uppercase tracking-wider">Dealers</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#222222] border border-white/5 p-8 text-center hover:border-[#FF6A00]/50 transition-colors"
                >
                  ...
                  <p className="text-[#6B7280] text-sm">{benefit.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-24 bg-[#1A1A1A]">
        <div className="max-w-3xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            ...
            <h2 className="font-['Barlow_Condensed'] font-bold text-4xl md:text-5xl uppercase tracking-tight text-white mb-4">
              Dealer Application
            </h2>
          ...
          {submitted ? (
            <div data-testid="dealer-form-success" className="bg-[#0F3D2E] p-12 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#FF6A00] text-white font-['IBM_Plex_Sans'] font-bold text-sm uppercase tracking-widest px-6 py-4"
              >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <label className="text-[#6B7280] text-sm mb-2 block">Business Name</label>
                  <input
                    type="text"
                    name="business_name"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label className="text-[#6B7280] text-sm mb-2 block">City *</label>
                  <input
                    type="text"
                    name="city"
                    value={formData.city}
                ...
                <div>
                  <label className="text-[#6B7280] text-sm mb-2 block">State</label>
                  <input
                    type="text"
                    name="state"
              ...
              <div className="mb-6">
                <label className="text-[#6B7280] text-sm mb-2 block">Business Type *</label>
                <select
                  name="business_type"
              ...
              <div className="mb-8">
                <label className="text-[#6B7280] text-sm mb-2 block">Message (Optional)</label>
                <textarea
                  name="message"
